...
describe('PlayerGamePanel', () => {
  ...
  it('sends one buzz while pending', async () => {
    ...
    render(<PlayerGamePanel room={activeRoom()} playerId="player-1" playerToken="token" />)
  ...
  it.each([
    ...
    render(<PlayerGamePanel room={room} playerId="player-1" playerToken="token" />)
  ...
  it('shows reveal, scoreboard, and final scoreboard', () => {
    ...
    const { rerender } = render(<PlayerGamePanel room={room} playerId="player-1" playerToken="token" />)
    ...
    rerender(<PlayerGamePanel room={room} playerId="player-1" playerToken="token" />)
